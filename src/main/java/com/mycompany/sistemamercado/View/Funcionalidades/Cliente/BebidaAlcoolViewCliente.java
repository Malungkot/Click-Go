 ...
 * @author augus
 */
public class BebidaAlcoolViewCliente extends javax.swing.JFrame {
    ...
    public BebidaAlcoolViewCliente() {
        ...
        try {
            ...
            jListBebidaAlcoolica.setModel(comAlcool);
    ...
    private void initComponents() {
        ...
        jListBebidaAlcoolica = new javax.swing.JList<>();
        ...
        jListBebidaAlcoolica.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jListBebidaAlcoolicaMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jListBebidaAlcoolica);
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(178, 392));
        ...
        jLabel1.setText("Bebidas Alcoolica:");
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        // TODO add your handling code here:
            ...
            int selectedIndex = jListBebidaAlcoolica.getSelectedIndex();

            if (selectedIndex != -1) { // Verifica se algum alimento foi selecionado
                BebidaComAlcool bebidaSelecionado = jListBebidaAlcoolica.getModel().getElementAt(selectedIndex); // Obtém o alimento selecionado
                if (bebidaSelecionado.getEstoque() > 0) {
                    ...
                    try {
                        BebidaController.editaBebidaComAlcool(BebidaComAlcool.getListaBebidasComAlcool().get(selectedIndex), bebidaSelecionado);
    ...
    private void jListBebidaAlcoolicaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jListBebidaAlcoolicaMouseClicked

    }//GEN-LAST:event_jListBebidaAlcoolicaMouseClicked

    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        // TODO add your handling code here:
        try {
            BebidaComAlcool bebidaBanco = null;
            BancoDeDados.leBDAlimento(BancoDeDados.getBancoAlimento());

            // Pega o alimento que foi selecionado
            int selectedIndex = jListBebidaAlcoolica.getSelectedIndex(); // Obtém o índice do item selecionado
            if (selectedIndex != -1) { // Verifica se algum item foi selecionado
                bebidaBanco = BebidaComAlcool.getListaBebidasComAlcool().get(selectedIndex);
                removerPedido(bebidaBanco);
                bebidaBanco.setEstoque(bebidaBanco.getEstoque() + 1);
                BebidaController.editaBebidaComAlcool(BebidaComAlcool.getListaBebidasComAlcool().get(selectedIndex), bebidaBanco);
                preencherJList();
            } else {
                JOptionPane.showMessageDialog(null, "Selecione uma bebida para tirar da Lista.");
                return; // Sai do método se nenhum alimento for selecionado
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BebidaAlcoolViewCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BebidaAlcoolViewCliente().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<BebidaComAlcool> jListBebidaAlcoolica;
